...
declare module 'rclnodejs' {
  ...
  namespace interfaces {
    namespace action {
      ...
      export interface Fibonacci_FeedbackMessage {
        goal_id: unique_identifier_msgs.msg.UUID;
        feedback: interfaces.action.Fibonacci_Feedback;
      }
      export interface Fibonacci_FeedbackMessageConstructor {
        new(other?: Fibonacci_FeedbackMessage): Fibonacci_FeedbackMessage;
      }
      ...
      export interface Fibonacci_GetResult_Response {
        status: number;
        result: interfaces.action.Fibonacci_Result;
      }
      export interface Fibonacci_GetResult_ResponseConstructor {
        new(other?: Fibonacci_GetResult_Response): Fibonacci_GetResult_Response;
      }
      ...
      export interface Fibonacci_SendGoal_Request {
        goal_id: unique_identifier_msgs.msg.UUID;
        goal: interfaces.action.Fibonacci_Goal;
      }
      export interface Fibonacci_SendGoal_RequestConstructor {
        new(other?: Fibonacci_SendGoal_Request): Fibonacci_SendGoal_Request;
      }
    ...
    namespace msg {
      ...
      export interface LeakTestResultConstructor {
        new(other?: LeakTestResult): LeakTestResult;
      }
      export interface PcsYc {
        dc_voltage: number;
        ac_voltage: number;
        dc_current: number;
        ac_current: number;
      ...
      export interface PcsYcConstructor {
        new(other?: PcsYc): PcsYc;
      }
      export interface PcsYk {
        start_stop_ctrl: boolean;
      }
      export interface PcsYkConstructor {
        new(other?: PcsYk): PcsYk;
      }
      export interface PcsYt {
        op_mode_ctrl: number;
        dc_voltage_ctrl: number;
        active_power_ctrl: number;
        reactive_power_ctrl: number;
      }
      export interface PcsYtConstructor {
        new(other?: PcsYt): PcsYt;
      }
      export interface PcsYx {
        short_circuit_alarm: boolean;
        polarity_reversal_alarm: boolean;
        dc_over_voltage_alarm: boolean;
        dc_under_voltage_alarm: boolean;
        over_current_alarm: boolean;
        over_temperature_alarm: boolean;
        hardware_failure_alarm: boolean;
        anti_islandin_alarm: boolean;
        comm_fail_alarm: boolean;
        short_circuit_prot: boolean;
        polarity_reversal_prot: boolean;
        dc_over_voltage_prot: boolean;
        dc_under_voltage_prot: boolean;
        over_current_prot: boolean;
        over_temperature_prot: boolean;
        hardware_failure_prot: boolean;
        anti_islandin_prot: boolean;
        comm_fail_prot: boolean;
      }
      export interface PcsYxConstructor {
        new(other?: PcsYx): PcsYx;
      }
    }
    namespace srv {
      export interface AddTwoIntsConstructor extends ROSService {
      ...
      export interface SetFloat64Constructor extends ROSService {
        readonly Request: SetFloat64_RequestConstructor;
        readonly Response: SetFloat64_ResponseConstructor;
      }
      export interface SetFloat64_Request {
        data: number;
      }
      export interface SetFloat64_RequestConstructor {
        new(other?: SetFloat64_Request): SetFloat64_Request;
      }
      export interface SetFloat64_Response {
        success: boolean;
        message: string;
      }
      export interface SetFloat64_ResponseConstructor {
        new(other?: SetFloat64_Response): SetFloat64_Response;
      }
      export interface SetIntConstructor extends ROSService {
        readonly Request: SetInt_RequestConstructor;
        readonly Response: SetInt_ResponseConstructor;
      }
      export interface SetInt_Request {
        data: number;
      }
      export interface SetInt_RequestConstructor {
        new(other?: SetInt_Request): SetInt_Request;
      }
      export interface SetInt_Response {
        success: boolean;
        message: string;
      }
      export interface SetInt_ResponseConstructor {
        new(other?: SetInt_Response): SetInt_Response;
      }
  ...
  type MessagesMap = {
    ...
    'interfaces/action/Fibonacci_Feedback': interfaces.action.Fibonacci_Feedback,
    'interfaces/action/Fibonacci_FeedbackMessage': interfaces.action.Fibonacci_FeedbackMessage,
    'interfaces/action/Fibonacci_GetResult_Request': interfaces.action.Fibonacci_GetResult_Request,
    'interfaces/action/Fibonacci_GetResult_Response': interfaces.action.Fibonacci_GetResult_Response,
    'interfaces/action/Fibonacci_Goal': interfaces.action.Fibonacci_Goal,
    'interfaces/action/Fibonacci_Result': interfaces.action.Fibonacci_Result,
    'interfaces/action/Fibonacci_SendGoal_Request': interfaces.action.Fibonacci_SendGoal_Request,
    'interfaces/action/Fibonacci_SendGoal_Response': interfaces.action.Fibonacci_SendGoal_Response,
    'interfaces/msg/LeakTestResult': interfaces.msg.LeakTestResult,
    'interfaces/msg/PcsYc': interfaces.msg.PcsYc,
    'interfaces/msg/PcsYk': interfaces.msg.PcsYk,
    'interfaces/msg/PcsYt': interfaces.msg.PcsYt,
    'interfaces/msg/PcsYx': interfaces.msg.PcsYx,
    'interfaces/srv/AddTwoInts_Request': interfaces.srv.AddTwoInts_Request,
    'interfaces/srv/AddTwoInts_Response': interfaces.srv.AddTwoInts_Response,
    'interfaces/srv/SetBool_Request': interfaces.srv.SetBool_Request,
    'interfaces/srv/SetBool_Response': interfaces.srv.SetBool_Response,
    'interfaces/srv/SetFloat64_Request': interfaces.srv.SetFloat64_Request,
    'interfaces/srv/SetFloat64_Response': interfaces.srv.SetFloat64_Response,
    'interfaces/srv/SetInt_Request': interfaces.srv.SetInt_Request,
    'interfaces/srv/SetInt_Response': interfaces.srv.SetInt_Response,
    'interfaces/srv/SetString_Request': interfaces.srv.SetString_Request,
    'interfaces/srv/SetString_Response': interfaces.srv.SetString_Response,
  ...
  type MessageTypeClassConstructorMap = {
    ...
    'interfaces/action/Fibonacci_Feedback': interfaces.action.Fibonacci_FeedbackConstructor,
    'interfaces/action/Fibonacci_FeedbackMessage': interfaces.action.Fibonacci_FeedbackMessageConstructor,
    'interfaces/action/Fibonacci_GetResult_Request': interfaces.action.Fibonacci_GetResult_RequestConstructor,
    'interfaces/action/Fibonacci_GetResult_Response': interfaces.action.Fibonacci_GetResult_ResponseConstructor,
    'interfaces/action/Fibonacci_Goal': interfaces.action.Fibonacci_GoalConstructor,
    'interfaces/action/Fibonacci_Result': interfaces.action.Fibonacci_ResultConstructor,
    'interfaces/action/Fibonacci_SendGoal_Request': interfaces.action.Fibonacci_SendGoal_RequestConstructor,
    'interfaces/action/Fibonacci_SendGoal_Response': interfaces.action.Fibonacci_SendGoal_ResponseConstructor,
    'interfaces/msg/LeakTestResult': interfaces.msg.LeakTestResultConstructor,
    'interfaces/msg/PcsYc': interfaces.msg.PcsYcConstructor,
    'interfaces/msg/PcsYk': interfaces.msg.PcsYkConstructor,
    'interfaces/msg/PcsYt': interfaces.msg.PcsYtConstructor,
    'interfaces/msg/PcsYx': interfaces.msg.PcsYxConstructor,
    'interfaces/srv/AddTwoInts_Request': interfaces.srv.AddTwoInts_RequestConstructor,
    'interfaces/srv/AddTwoInts_Response': interfaces.srv.AddTwoInts_ResponseConstructor,
    'interfaces/srv/SetBool_Request': interfaces.srv.SetBool_RequestConstructor,
    'interfaces/srv/SetBool_Response': interfaces.srv.SetBool_ResponseConstructor,
    'interfaces/srv/SetFloat64_Request': interfaces.srv.SetFloat64_RequestConstructor,
    'interfaces/srv/SetFloat64_Response': interfaces.srv.SetFloat64_ResponseConstructor,
    'interfaces/srv/SetInt_Request': interfaces.srv.SetInt_RequestConstructor,
    'interfaces/srv/SetInt_Response': interfaces.srv.SetInt_ResponseConstructor,
    'interfaces/srv/SetString_Request': interfaces.srv.SetString_RequestConstructor,
    'interfaces/srv/SetString_Response': interfaces.srv.SetString_ResponseConstructor,
  ...
  type ServicesMap = {
    ...
    'interfaces/srv/AddTwoInts': interfaces.srv.AddTwoIntsConstructor,
    'interfaces/srv/SetBool': interfaces.srv.SetBoolConstructor,
    'interfaces/srv/SetFloat64': interfaces.srv.SetFloat64Constructor,
    'interfaces/srv/SetInt': interfaces.srv.SetIntConstructor,
    'interfaces/srv/SetString': interfaces.srv.SetStringConstructor,
  ...
  type ActionsMap = {
    ...
    'interfaces/action/Fibonacci': interfaces.action.FibonacciConstructor,
